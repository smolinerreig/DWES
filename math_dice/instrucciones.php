    ...
    <body>
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="well fondo-negro">
                        <p class="text-justify">Al entrar en cualquiera de las opciones de juego (ambas son idénticas, pues Aun no se ha implementado el modo Junior+) habrán 6 dados: 
                    ...
                    <div class="well fondo-negro">
                        ...
                        <ul>
                            ...
                            <li>Contraseña encriptada como requisito para entrar en la página</li>
                            <li>Almacenamiento de datos en base de datos Mysql</li>
                            <li>Modificación de datos y contraseña</li>
                            <li>¡Toneladas de diversión!</li>
                        </ul>
                    </div>
                </div>
            </div>
